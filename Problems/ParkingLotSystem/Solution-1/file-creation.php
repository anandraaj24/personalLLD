...
$files = [
    ...
    'truck.php',
    'parking-spot.php',
    'handicapped-spot.php',
    'compact-spot.php',
    'large-spot.php',
    'parking-attendant.php',
    'entrance-panel.php',
    'exit-panel.php',
    'parking-display-board.php',
    'payment-strategy.php',
    'cash-payment-strategy.php',
    'credit-card-payment-strategy.php',
    'command.php',
    'process-ticket-command.php',
    'parking-full-exception.php'
];
